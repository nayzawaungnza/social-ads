@extends('layouts/master', ['activePage' => 'services.update', 'titlePage' => __('Edit Service')])
                ...
                @endisset
                  ...
                  <div class="row g-3">
                    ...
                    <div>
                      ...
                      <textarea id="editor" name="description" style="height: 300px; width: 100%;" class=" form-control" placeholder="Enter Description">{{ old('description', $service->description) }}</textarea>
                  ...
                  <div class="row g-3">
                    ...
                    <div class="col-md-6">
                      ...
                      <textarea id="excerpt" name="excerpt" class="form-control @error('excerpt') is-invalid @enderror" placeholder="enter excerpt">{{ old('excerpt', $service->excerpt) }}</textarea>
                      @error('excerpt')
                          <span class="error invalid-feedback" style="margin-left:8px;display:block;">{{ $message }}</span>
                        @enderror
                    </div>
